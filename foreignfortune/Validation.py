...
class Validation:
    ...
    def is_valid_product_data(product_data):
        ...
        required_keys = ['brand', 'title', 'product_id', 'url', 'original_price']
    ...
    def validate_product_data_schema(product_data):
        ...
        for key, value in expected_structure.items():
            if key not in product_data:
                return False
            if not isinstance(product_data[key], value):
                return False
    ...
    def validate_pdp_data(json_data):
        ...
        if not Validation.validate_product_data_schema(product_data):
            return False, "Invalid product data schema"
        
        if not Validation.validate_selling_price(product_data):
            return False, "Selling price cannot be greater than original price"
...
if __name__ == "__main__":
    ...
    product_ids = set()  
    with open(r'Output\foreignfortune_pdp_data.json', 'r') as f:
